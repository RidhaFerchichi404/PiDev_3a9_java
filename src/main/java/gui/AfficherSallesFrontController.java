...
public class AfficherSallesFrontController {
    ...
    private VBox createSalleCard(SalleDeSport salle) {
        ...
        // Effet hover (avec types d'événements corrects)
        card.addEventHandler(MouseEvent.MOUSE_ENTERED, (MouseEvent e) -> {
            card.setStyle("-fx-background-color: #333333; "
                    + "-fx-border-color: #FF6600; "
                    + "-fx-border-radius: 20; "
                    + "-fx-background-radius: 20; "
                    + "-fx-padding: 20; "
        ...
        card.addEventHandler(MouseEvent.MOUSE_EXITED, (MouseEvent e) -> {
            card.setStyle("-fx-background-color: #262626; "
                    + "-fx-border-color: #FF6600; "
                    + "-fx-border-radius: 20; "
                    + "-fx-background-radius: 20; "
        ...
        voirEquipementsButton.addEventHandler(MouseEvent.MOUSE_ENTERED, (MouseEvent e) -> {
            voirEquipementsButton.setStyle("-fx-background-color: #CC5200; "
                    + "-fx-text-fill: white; "
                    + "-fx-font-weight: bold; "
                    + "-fx-font-size: 16px; "
                    + "-fx-background-radius: 10; "
        ...
        voirEquipementsButton.addEventHandler(MouseEvent.MOUSE_EXITED, (MouseEvent e) -> {
            voirEquipementsButton.setStyle("-fx-background-color: #FF6600; "
                    + "-fx-text-fill: white; "
                    + "-fx-font-weight: bold; "
                    + "-fx-font-size: 16px; "
