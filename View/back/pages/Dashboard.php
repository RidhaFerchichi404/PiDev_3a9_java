...
if(isset($_SESSION['user'])) {
    ...
    header("Location: index.php"); // Remplacez "login.php" par la page de connexion
    exit();
}
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <ul class="navbar-nav ml-auto">
                    <li class="nav-item" title="Search">
                        <a href="profilefront.php" class="search-search nav-link">
                            <li class="mr-2 d-none d-lg-inline text-gray-600 small session-name"><?php echo $_SESSION['user'];?></li>
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <tbody>
                <?php foreach ($users as $user) { ?>
                    <tr>
                        ...
                        <td class="actions">
                            <a href="editUser.php?id=<?php echo $user['id']; ?>">✏️ Modifier</a>
